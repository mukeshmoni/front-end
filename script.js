const products = [
  ...
  { id: 7, name: 'Product 7', description: 'Description for product 7. High-quality item.', price: 55.00, image: 'assets/images/product7.png', isNew: true },
  ...
  { id: 10, name: 'Product 10', description: 'Description for product 10. High-quality item.', price: 34.99, image: 'assets/images/product10.png', isNew: false },
  ...
  { id: 15, name: 'Product 15', description: 'Description for product 15. High-quality item.', price: 39.49, image: 'assets/images/product15.png', isNew: true },
  { id: 16, name: 'Product 16', description: 'Description for product 16. High-quality item.', price: 50.00, image: 'assets/images/product16.png', isNew: false },
  ...
  { id: 20, name: 'Product 20', description: 'Description for product 20. High-quality item.', price: 77.99, image: 'assets/images/product20.png', isNew: false },
  { id: 21, name: 'Product 21', description: 'Description for product 21. High-quality item.', price: 27.50, image: 'assets/images/product21.png', isNew: true },
  ...
  { id: 24, name: 'Product 24', description: 'Description for product 24. High-quality item.', price: 18.75, image: 'assets/images/product24.png', isNew: false },
  ...
  { id: 28, name: 'Product 28', description: 'Description for product 28. High-quality item.', price: 72.45, image: 'assets/images/product28.png', isNew: false },
  ...
  { id: 31, name: 'Product 31', description: 'Description for product 31. High-quality item.', price: 61.75, image: 'assets/images/product31.png', isNew: true },
  { id: 32, name: 'Product 32', description: 'Description for product 32. High-quality item.', price: 80.00, image: 'assets/images/product32.png', isNew: false },
  { id: 33, name: 'Product 33', description: 'Description for product 33. High-quality item.', price: 36.00, image: 'assets/images/product33.png', isNew: true },
  { id: 34, name: 'Product 34', description: 'Description for product 34. High-quality item.', price: 54.99, image: 'assets/images/product34.png', isNew: false },
  { id: 35, name: 'Product 35', description: 'Description for product 35. High-quality item.', price: 89.99, image: 'assets/images/product35.png', isNew: true },
  ...
  { id: 38, name: 'Product 38', description: 'Description for product 38. High-quality item.', price: 33.99, image: 'assets/images/product38.png', isNew: false },
