...
//   // Filter logic
//   if (document.getElementById('filterPriceCheckbox').checked) {
//     filteredProducts = filteredProducts.filter((product) => product.price < 50);
//   }
//   if (document.getElementById('filterNewCheckbox').checked) {
//     filteredProducts = filteredProducts.filter((product) => product.isNew);
//   }
...
// document.getElementById('filterPriceCheckbox').addEventListener('change', applyFiltersAndSort);
// document.getElementById('filterNewCheckbox').addEventListener('change', applyFiltersAndSort);
